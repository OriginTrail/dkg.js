...
const nodeKeys = {
  'Node 25': {
    publicKey: process.env.JS_MAINNET_BASE_NODE25_PUBLIC_KEY,
    privateKey: process.env.JS_MAINNET_BASE_NODE25_PRIVATE_KEY
  },
  'Node 26': {
    publicKey: process.env.JS_MAINNET_BASE_NODE26_PUBLIC_KEY,
    privateKey: process.env.JS_MAINNET_BASE_NODE26_PRIVATE_KEY
  },
  'Node 27': {
    publicKey: process.env.JS_MAINNET_BASE_NODE27_PUBLIC_KEY,
    privateKey: process.env.JS_MAINNET_BASE_NODE27_PRIVATE_KEY
  },
  'Node 28': {
    publicKey: process.env.JS_MAINNET_BASE_NODE28_PUBLIC_KEY,
    privateKey: process.env.JS_MAINNET_BASE_NODE28_PRIVATE_KEY
  },
  'Node 29': {
    publicKey: process.env.JS_MAINNET_BASE_NODE29_PUBLIC_KEY,
    privateKey: process.env.JS_MAINNET_BASE_NODE29_PRIVATE_KEY
  },
  'Node 30': {
    publicKey: process.env.JS_MAINNET_BASE_NODE30_PUBLIC_KEY,
    privateKey: process.env.JS_MAINNET_BASE_NODE30_PRIVATE_KEY
  }
};
...
describe('DKG Asset Lifecycle on Base Mainnet', function () {
  ...
  it('should sequentially test selected node(s)', async () => {
    ...
    for (let currentIndex = 0; currentIndex < nodesToRun.length; currentIndex++) {
      ...
      globalStats[BLOCKCHAIN_IDS.BASE_MAINNET][name] = {
        publishSuccess,
        publishFail,
        querySuccess,
        queryFail,
      ...
      const summary = {
        blockchain_name: BLOCKCHAIN_IDS.BASE_MAINNET,
        node_name: name,
      ...
      const errorData = {
          blockchain_id: BLOCKCHAIN_IDS.BASE_MAINNET,
