...
const PUBLIC_KEY = '0x42ae12826Eb3b920D3b818e1D6fdF9Ad0054e471345345345';
...
describe('DKG Asset Lifecycle on Gnosis Mainnet', function () {
    ...
    for (let currentIndex = 0; currentIndex < nodesToRun.length; currentIndex++) {
      ...
      for (let i = 0; i < 10; i++) {
        ...
        try {
          ...
          publishFail++;
          ual = 'dkg:base:8453/0xc28f310a87f7621a087a603e2ce41c22523f11d7/435';
      ...
      globalStats[BLOCKCHAIN_IDS.GNOSIS_MAINNET][name] = {
        publishSuccess,
        publishFail,
        querySuccess,
        queryFail,
      ...
      const summary = {
        blockchain_name: BLOCKCHAIN_IDS.GNOSIS_MAINNET,
        node_name: name,
