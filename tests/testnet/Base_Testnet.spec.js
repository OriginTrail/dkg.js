...
function getNodeWallet(nodeId, walletSlot = null) {
  ...
  const prefixedPublic = process.env[`JS_TESTNET_BASE_NODE${normalizedNodeId}_W${resolvedWalletSlot}_PUBLIC_KEY`];
  const prefixedPrivate = process.env[`JS_TESTNET_BASE_NODE${normalizedNodeId}_W${resolvedWalletSlot}_PRIVATE_KEY`];
  const legacyPublic = process.env[`JS_TESTNET_BASE_NODE${normalizedNodeId}_PUBLIC_KEY`];
  const legacyPrivate = process.env[`JS_TESTNET_BASE_NODE${normalizedNodeId}_PRIVATE_KEY`];
